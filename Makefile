...
main.o: main.h bsdMake.h genMake.h ruleList.h rule.h
	g++ -c -Wall main.cpp

bsdMake.o: genMake.h bsdMake.h ruleList.h rule.h
	g++ -c -Wall bsdMake.cpp

genMake.o: genMake.h ruleList.h rule.h
	g++ -c -Wall genMake.cpp

ruleList.o: ruleList.h rule.h
